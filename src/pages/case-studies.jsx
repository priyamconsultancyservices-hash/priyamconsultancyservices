...
const cards = [
  { id:1,  seed:13,  badge:"bdg-dm",  label:"Perfomance Marketing", tags:["SEO"],                   client:"Tactive",                    slug:"tactive",    title:"From Zero Lead Pipeline to 35 Cr+ Qualified Pipeline for a Construction Tech ERP Brand",        overview:"Tactive Software Systems is a technology-driven company delivering dedicated construction ERP solutions . Backed by over 17 years of research and development and supported by the industry expertise of URC Constructions, Tactive helps construction businesses streamline operations and make data-driven decisions." },
  { id:2,  seed:26,  badge:"bdg-seo", label:"SEO",               tags:["Perfomance Marketing"], client:"SterloCare",                  slug:"sterlocare",              title:"Enterprise Lead Generation Across India and GCC for a Healthcare SaaS Brand",                    overview:"SterloCare, powered by the OREOPS Framework, delivers low-code technology solutions for web and mobile application development. Established in 2016, the company helps businesses streamline workflows, manage operations, and build scalable digital solutions with minimal coding. Operating across India, GCC, Africa, and the USA, SterloCare focuses on innovation, enterprise performance, and user-centric technology experiences." },
  { id:3,  seed:39,  badge:"bdg-dm",  label:"Website Development", tags:["SEO"],                   client:"URCTS",                      slug:"urcts",            title:"Building a Strong Brand Identity and Digital Presence for an Engineering Firm",                   overview:"URCTS is a global engineering solutions provider serving Oil & Gas, industrial, and infrastructure sectors with multidisciplinary expertise. Established in 2023, the company builds on the engineering legacy of URC Constructions (P) Ltd. URCTS delivers integrated solutions from concept to commissioning with a focus on precision, compliance, and operational excellence. With experience across India, the Middle East, Europe, and the USA, the company supports complex engineering projects with scalable and reliable execution. " },
  { id:4,  seed:52,  badge:"bdg-seo", label:"E-Commerence Website Development",               tags:["Local SEO"],    client:"Feral Roots",                slug:"feral-roots", title:"From Brand Study to Performance-Driven E-Commerce Growth for a Sustainable Products Brand",       overview:"Feral Roots is a sustainable lifestyle brand focused on empowering tribal communities through ethical trade and responsible sourcing practices. The company works closely with local communities to source natural and millet-based products at fair prices while creating sustainable livelihood opportunities." },
  { id:5,  seed:78,  badge:"bdg-ppc", label:"Meta Ads",         tags:[],                   client:"Ey Chiquita",                slug:"ey-chiquita",            title:"Driving 100 Qualified Leads Through Social Media Marketing for a Fashion Brand",                  overview:"Ey Chiquita is a fashion and lifestyle brand focused on creating trend-driven products and engaging digital experiences for modern consumers. The brand emphasizes style, audience engagement, and strong social media presence to connect with fashion-focused customers." },
  { id:6,  seed:91,  badge:"bdg-seo", label:"SEO",               tags:["Website Development"],    client:"ZKY",                        slug:"zky",              title:"Establishing a Professional Digital Presence for an HR Verification Company",                    overview:"ZKY wanted a professional online identity that reflected trust, accuracy, and reliability within the HR verification industry. We created a structured digital presence designed to strengthen credibility and support business enquiries." },
  { id:7,  seed:104, badge:"bdg-dm",  label:"SEO", tags:["Website Development", "SMM"],                   client:"RIYA",                       slug:"riya",                      title:"Building a Credible Digital Presence for a Business Consulting Firm",                           overview:"Focused on delivering business consulting and operational support solutions, the company helps organizations improve efficiency, compliance, and long-term growth through structured and professional advisory services across multiple business functions." },
  { id:8,  seed:117, badge:"bdg-smm", label:"Website Development",      tags:["SEO"],                   client:"ABB",                        slug:"abb",                      title:"Strengthening Digital Presence for a Digital Transformation Company",                          overview:"ABB Management Consulting helps MSMEs accelerate growth through Digital Transformation, Application Development, and Process Automation solutions. The company focuses on improving operational efficiency, streamlining business processes, and enabling sustainable growth through technology-driven strategies and innovation-focused consulting services." },
  { id:9, seed:130, badge:"bdg-ppc", label:"Content Marketing",         tags:["SEO"],                   client:"Sterlo",                     slug:"sterlo",          title:"Enterprise Lead Generation Across India and GCC for a Low Code No Code Platform",               overview:"Sterlo is a low code / no code platform developed under the OREOPS Framework, enabling businesses to create web and mobile applications, manage workflows, and generate reports with minimal coding." },
  { id:10, seed:143, badge:"bdg-dm",  label:"SEO", tags:["Content Marketing"],                   client:"SterloBuild",                slug:"sterlobuild",               title:"Enterprise Lead Generation Across India for a Construction Tech SaaS Brand",                    overview:"SterloBuild is a construction technology SaaS platform focused on simplifying construction workflows and improving operational efficiency through digital solutions designed for the construction industry." },
  { id:11, seed:156, badge:"bdg-seo", label:"Recruitment Service",               tags:["Payroll"], client:"Analytix Hub",               slug:"analytix-hub",                        title:"Fast Recruitment and On-Time Payroll Enablement for an IT Company",                            overview:"Analytix Hub is an IT services firm delivering technology solutions and operational support for business scaling needs." },
  { id:12, seed:169, badge:"bdg-smm", label:"Recruitment Service",      tags:[],                   client:"AINQA",                      slug:"ainqa",                                        title:"On-Time Recruitment Closure for Critical IT Roles",                                           overview:"AINQA is a technology company specializing in digital services and IT solutions for diverse industries." },
  { id:13, seed:182, badge:"bdg-ppc", label:"Recruitment Service",         tags:[],                   client:"StarHealth",                 slug:"starhealth",                                   title:"Bulk Recruitment Support for a Leading Insurance Brand",                                      overview:"StarHealth is a prominent insurance provider offering comprehensive health solutions across India, supported by a large and diverse workforce." },
  { id:14, seed:195, badge:"bdg-dm",  label:"Recruitment Service", tags:[],                   client:"Baltimore Health Analytics", slug:"baltimore-health-analytics",                         title:"Recruitment Support for a US-Based Healthcare Analytics Company",                             overview:"Baltimore Health Analytics is a healthcare-focused analytics company supporting HEDIS consulting, Medicare Advantage operations, and data-driven healthcare solutions." },
...
function Badge({ cls, label, tags = [] }) {
  return (
    <div className="badges-row">
      <div className={`cat-badge ${cls}`}>
        <span className="dot" />
        {label}
      </div>
      {tags.map(tag => (
        <div key={tag} className="cat-badge bdg-tag">
          <span className="dot" />
          {tag}
        </div>
      ))}
...
function CaseStudyCard({ card }) {
  const { seed, badge, label, tags, title, client, overview, slug } = card;

  return (
    <a className="cs-card" href={`/case-studies/${slug}`}>
      <div className="cs-thumb">
        <img src={`https://picsum.photos/seed/${seed}/600/340`} alt={title} />
      </div>
      <div className="cs-body">
        <Badge cls={badge} label={label} tags={tags} />
        {client && <div className="cs-client">{client}</div>}
        {overview && <p className="cs-overview">{overview}</p>}
