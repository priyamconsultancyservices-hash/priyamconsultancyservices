...
const SERVICES = [
  ...
  { num: "02", icon: <img src="/img/icon/svc-content-audits.webp" alt="Content Audits and Optimization" width="28" height="28" />, subtitle: "Visual Identity", title: "Content Audits & Optimization", desc: "Make your existing content work harder. We audit, update, and reoptimize underperforming content to improve rankings, engagement, and conversions.", },
  { num: "03", icon: <img src="/img/icon/svc-seo-content.webp" alt="SEO Content Writing" width="28" height="28" />, subtitle: "Paid Campaigns", title: "SEO Content Writing", desc: "Get found where it matters. We create keyword-optimized content that speaks to both search engines and your audience balancing rankings with relevance.", },
  { num: "04", icon: <img src="/img/icon/svc-website-copy.webp" alt="Website and Landing Page Copy" width="28" height="28" />, subtitle: "Community Building", title: "Website & Landing Page Copy", desc: "Every word on your site should sell. We write persuasive, conversion-optimized website and landing page content that drives action and boosts performance.", },
  { num: "05", icon: <img src="/img/icon/svc-thought-leadership.webp" alt="Thought Leadership and Blogs" width="28" height="28" />, subtitle: "Partnerships", title: "Thought Leadership & Blogs", desc: "Establish authority in your niche. Our team writes compelling, research-backed blogs and articles that reflect your expertise and connect with your readers.", },
  { num: "06", icon: <img src="/img/icon/svc-social-email-content.webp" alt="Content for Social and Email" width="28" height="28" />, subtitle: "Insights & ROI", title: "Content for Social & Email", desc: "Fuel your marketing channels. From social captions to email nurture series, we craft engaging content that keeps your brand top-of-mind and drives engagement.", },
];
...
const faqData = [
  { q: "What Does Content Marketing Actually Do For My Business?", a: "Content marketing helps attract your target audience, establish your authority, improve SEO rankings, and convert readers into leads or customers all through valuable, relevant content." },
  { q: "Do You Write For My Industry Specifically?", a: "Yes. We tailor content to your business, industry, and audience. Our writers research deeply to ensure every piece reflects your brand’s expertise." },
  { q: "How Do You Decide What Content To Create?", a: "We start with a strategy phase where we align with your business goals, perform keyword research, identify gaps, and develop a content calendar accordingly." },
  { q: "Can You Rewrite Or Optimize My Existing Content?", a: "Absolutely. We audit your current content, update it for SEO, improve clarity, and rework it to perform better across search and engagement metrics." },
  { q: "Will I get reports on how the content is performing?", a: "Yes. We share performance reports that track rankings, engagement, traffic, and conversions so you always know what’s working." },
  { q: "Do You Offer Design Or Visuals With Content?", a: "Yes, if needed. We collaborate with design partners to deliver infographics, social creatives, or visual-rich content to boost engagement and shareability." },
];
...
function Hero() {
  return (
      ...
      <div className="hero-left">
        <div className="h-badge"><div className="badge-dot" />Content Marketing</div>
  ...
  return (
    <section className="smm-svc">
      ...
      <div className="smm-svc-hdr">
        <div className="partners-header1">
          <div className="partners-eyebrow" style={{ marginBottom: '20px', textAlign: 'start' }}>Our Specialized Content Marketing Services</div>
        </div>
        <h2 className="smm-svc-h2">Not Just Content. <span> <i>Content That Works.</i></span></h2>
        <p className="smm-svc-sub">
 At Priyam Consultancy Services, we go beyond generic blogs. We craft conversion-focused, insight-led content tailored to your brand, industry, and audience journey.
  ...
  return (
    <section className="smm-tp-section">
      ...
      <div className="smm-tp-header">
        <div className="partners-header1">
          <div className="partners-eyebrow" style={{ marginBottom: '20px', textAlign: 'start' }}>Our Proven Content Marketing Process</div>
        </div>
        <h2 className="smm-tp-h2">Built on Strategy. <em> <i>Refined by Insight. </i></em> Measured by Impact.</h2>
        <p className="smm-tp-sub">
     Our content marketing process that will make your brand unique, and value proposition end for each stage for your customer. Let’s see how Priyam Consultancy Services thought process can be a game changer for your business.
  ...
  return (
    <section className="smm-hww">
      ...
      <div className="smm-hww-header">
        <div className="partners-header1">
          <div className="partners-eyebrow" style={{ marginBottom: '20px', textAlign: 'start' }}>Our Focus on Your Results in Content Marketing</div>
        </div>
        <h2 className="smm-hww-h2">Plan Smart.  <span><i>Write Better.</i></span> Deliver Results.</h2>
      </div>
