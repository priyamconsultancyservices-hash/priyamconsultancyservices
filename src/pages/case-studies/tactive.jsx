        ...
        <section className="detail-banner">
          <div className="detail-banner-inner">
            <h1 className="detail-banner-title">
              From Zero Lead Pipeline to ₹35 Cr+ Qualified Pipeline for a Construction Tech ERP Brand
            </h1>
          </div>
        </section>
        ...
        <div className="detail-page-body">
          ...
          <div className="detail-left">
            ...
            <div className="detail-section">
              <h2>Our Strategy</h2>
              <ul>
                <li>Conducted competitor research and high-intent keyword analysis for construction ERP markets</li>
                <li>Revamped website content with construction-specific messaging and SEO optimization</li>
                <li>Developed conversion-focused landing pages targeting construction industry decision-makers</li>
                <li>Executed targeted bidding strategies to improve qualified lead generation performance</li>
                <li>Published SEO-driven blogs to strengthen organic visibility and search rankings</li>
                <li>Used heatmaps and Microsoft Clarity insights to optimize user experience, engagement, and conversions</li>
              </ul>
            </div>
