...
export default function CaseStudy() {
 ...
 <div className="detail-section">
              ...
              <p>Cure Tech is a startup operating within the printing and packaging industry, focused on building efficient operational capabilities and strengthening its workforce during the early stages of business growth.
</p>
            </div>
            <div className="detail-section">
              <h2>Overview</h2>
              <p>Cure Tech required immediate recruitment support to fulfill urgent hiring requirements and maintain smooth operational workflows during a crucial expansion phas</p>
            </div>

            <div className="detail-section">
              <h2>The Challenge</h2>
              <p>As a growing startup, the company faced time-sensitive hiring needs and required quick workforce onboarding to avoid operational slowdowns and maintain productivity within tight timelines.
</p>
            </div>
...
<li>Completed hiring requirements within a 1–2 week timeline
            ...
            <div className="detail-section">
              <h2>The Result</h2>
              <p>We helped Cure Tech successfully close its urgent hiring requirements within a short turnaround period, enabling the company to maintain operational continuity and support business expansion without recruitment-related delays.
</p>
            </div>
