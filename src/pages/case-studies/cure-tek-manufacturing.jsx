...
export default function CaseStudy() {
  return (
    <Layout title="Cure Tech Case Study: Hiring Closed in 1–2 Weeks | PCS" description="Discover how PCS helped Cure Tech meet urgent hiring needs through efficient recruitment strategies, workforce expansion, and uninterrupted operations.  ">
      <Head>
        <title>Cure Tech Case Study: Hiring Closed in 1–2 Weeks | PCS</title>
        <meta name="description" content="Discover how PCS helped Cure Tech meet urgent hiring needs through efficient recruitment strategies, workforce expansion, and uninterrupted operations.  " />
        <link rel="canonical" href="https://www.priyamconsultancy.com/case-studies/cure-tek-manufacturing/" />
        <meta property="og:title" content="Cure Tech Case Study: Hiring Closed in 1–2 Weeks | PCS" />
        <meta property="og:description" content="Discover how PCS helped Cure Tech meet urgent hiring needs through efficient recruitment strategies, workforce expansion, and uninterrupted operations.  " />
        <meta property="og:image" content="https://picsum.photos/seed/13/1200/630" />
        <meta property="og:url" content="https://www.priyamconsultancy.com/case-studies/cure-tek-manufacturing/" />
      </Head>
      <style>{styles}</style>
      ...
      <div className="detail-wrap">
        ...
        <section className="detail-banner">
          <div className="detail-banner-inner">
            <h1 className="detail-banner-title">Fast Recruitment Support for a Printing & Packaging Startup
            </h1>
          </div>
        </section>
        ...
        <div className="detail-page-body">
          ...
          <div className="detail-left">
            ...
            <div className="detail-hero-img">
              <img src="/img/case-study-curetech-about.webp" alt="From Zero Lead Pipeline to 35 Cr+ Qualified Pipeline for a Construction Tech ERP Brand" />
            </div>
            ...
            <div className="detail-section">
              ...
              <p>
                Cure Tech is a startup in the printing and packaging industry focused on building strong operational capabilities and a skilled workforce. The company aims to support sustainable business growth through efficient processes, quality-driven production, and strategic resource management during its expansion phase.
              </p>
            </div>
            <div className="detail-section">
              <h2>Overview</h2>
              <p>
                Cure Tech required immediate recruitment support to meet urgent hiring demands and maintain uninterrupted operational workflows during a critical growth phase. The company sought qualified talent quickly to strengthen its workforce, improve productivity, and support business expansion without delays or resource shortages.
              </p>
            </div>
            ...
            <div className="detail-section">
              <h2>The Challenge</h2>
              <p>
                As a growing startup, Cure Tech faced time-sensitive hiring requirements and needed rapid workforce onboarding to sustain operational efficiency. Delays in recruitment could impact productivity, resource availability, and business growth, making a structured and responsive hiring process essential for continued expansion.
              </p>
            </div>
            ...
            <div className="detail-section">
              <h2>Our Strategy</h2>
              <ul>
                <li>Understood startup hiring priorities and operational workforce requirements
                </li>
                <li>Focused on rapid candidate sourcing and profile screening
                </li>
                <li>Streamlined interview coordination and recruitment communication
                </li>
                <li>Prioritized immediate role closures for operational continuity
                </li>
                <li>Managed fast-track onboarding support for selected candidates
                </li>
            ...
            <div className="detail-section">
              <h2>The Result</h2>
              <p>
                Helped Cure Tech successfully fulfill its urgent hiring requirements within a short turnaround period. By accelerating recruitment and onboarding processes, the company maintained operational continuity, strengthened workforce capacity, and supported business expansion without delays caused by talent shortages or recruitment challenges.
              </p>
            </div>

            {/* CTA */}
            <div className="detail-cta-block">
              <h3>Ready to achieve results like Cure Tech?</h3>
          ...
          <div className="detail-sidebar">
            ...
            <div className="sidebar-about">
              ...
              <p>Client: <strong>Cure Tech</strong></p>
              <p>Service: </p>
