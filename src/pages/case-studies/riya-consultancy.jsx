...
export default function CaseStudy() {
  return (
    <Layout title="RIYA Consultancy SEO & Branding Case Study | PCS" description="We helped RIYA Consultancy establish a trustworthy digital presence through branding, SEO, and social media marketing, driving visibility and engagement.">
      <Head>
        <title>RIYA Consultancy SEO & Branding Case Study | PCS</title>
        <meta name="description" content="We helped RIYA Consultancy establish a trustworthy digital presence through branding, SEO, and social media marketing, driving visibility and engagement." />
        <link rel="canonical" href=" https://www.priyamconsultancy.com/case-studies/riya-consultancy/" />
        <meta property="og:title" content="RIYA Consultancy SEO & Branding Case Study | PCS" />
        <meta property="og:description" content="We helped RIYA Consultancy establish a trustworthy digital presence through branding, SEO, and social media marketing, driving visibility and engagement." />
        <meta property="og:image" content="https://picsum.photos/seed/13/1200/630" />
        <meta property="og:url" content=" https://www.priyamconsultancy.com/case-studies/riya-consultancy/" />
      </Head>
      <style>{styles}</style>
        ...
        <div className="detail-page-body">
          ...
          <div className="detail-left">
            ...
            <div className="detail-section">
              ...
              <p>
                Focused on delivering business consulting and operational support solutions, the company helps organizations improve efficiency, compliance, and long-term growth through structured and professional advisory services across multiple business functions.
              </p>
            </div>
            <div className="detail-section">
              <h2>Overview</h2>
              <p>
                The firm sought to strengthen its market position by building a credible digital presence that reflected its expertise and service capabilities. Through strategic branding, SEO, and social media marketing, the goal was to enhance visibility, build audience trust, and drive long-term business engagement.              </p>
            </div>

            <div className="detail-section">
              <h2>The Challenge</h2>
              <p>
                Although the company offered valuable consulting services, its digital communication lacked consistency and strategic positioning. The business required a clearer online structure, stronger visibility, and a professional digital ecosystem capable of improving audience trust, search presence, and client interaction opportunities.              </p>
            </div>
