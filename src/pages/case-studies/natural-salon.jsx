...
export default function CaseStudy() {
 ...
 <div className="detail-section">
              ...
              <p>Natural Salon is a beauty and wellness brand focused on delivering professional salon and grooming services through skilled talent, customer-focused experiences, and consistent service quality.
</p>
            </div>
            <div className="detail-section">
              <h2>Overview</h2>
              <p>Natural Salon required immediate recruitment support to fulfill urgent workforce requirements and maintain smooth business operations during an active growth phase.
</p>
            </div>

            <div className="detail-section">
              <h2>The Challenge</h2>
              <p>The salon needed quick hiring support for operational roles while maintaining candidate quality and reducing recruitment delays. Limited time and increasing staffing requirements created pressure on daily business operations.
</p>
            </div>
...
<li>Completed hiring requirements within a 1–2 week timeline
            ...
            <div className="detail-section">
              <h2>The Result</h2>
              <p>We helped Natural Salon complete its recruitment requirements within 1–2 weeks through targeted Meta Ads campaigns and structured recruitment execution. The hiring process reduced recruitment turnaround time by over 50%, improved candidate response rates, and enabled faster workforce onboarding while maintaining smooth day-to-day salon operations.
