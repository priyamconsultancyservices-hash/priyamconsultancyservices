...
export default function CaseStudy() {
 ...
 <div className="detail-section">
            ...
            <div className="detail-section">
              <h2>Overview</h2>
              <p>Baltimore Health Analytics required recruitment support to strengthen its workforce with professionals suited for healthcare analytics, HEDIS consulting, and Medicare Advantage-focused operations while ensuring uninterrupted business continuity.</p>
            </div>
