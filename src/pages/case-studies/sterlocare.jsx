      ...
      <div className="detail-wrap">
        ...
        <section className="detail-banner">
          <div className="detail-banner-inner">
            <h1 className="detail-banner-title">Enterprise Lead Generation Across India and GCC for a Healthcare SaaS Brand
            </h1>
          </div>
        </section>
        ...
        <div className="detail-page-body">
          ...
          <div className="detail-left">
            ...
            <div className="detail-hero-img">
              <img src="/img/case-study-sterlocare-about.webp" alt="Enterprise Lead Generation Across India and GCC for a Healthcare SaaS Brand" />
            </div>
            ...
            <div className="detail-section">
              <h2>Our Strategy</h2>
              <ul>
                <li>Executed product launch campaigns supported by SEO and performance marketing
                </li>
                <li>Conducted keyword research, content analysis, and search intent optimization
                </li>
                <li>Optimized meta titles, descriptions, and on-page content for healthcare keywords
                </li>
                <li>Developed conversion-focused landing pages for Google Ads campaigns</li>
                <li>Built region-specific campaigns targeting healthcare audiences across GCC markets
                </li>
                <li>Strengthened enterprise lead pipelines through strategic conversion-focused marketing initiatives.
                </li>
              </ul>
            </div>
            ...
            <div className="detail-section">
              <h2>The Result</h2>
              <p>SterloCare’s Daily search impressions increased from below 50 to over 300–500+ impressions per day. More than 100 healthcare-focused keywords were actively tracked, with 50+ keywords achieving Google Top 10 rankings. Through SEO, strategic content marketing, and performance campaigns, PCS helped SterloCare build a qualified enterprise lead pipeline exceeding ₹1 Cr while strengthening overall search presence, credibility, and conversion opportunities.
              </p>
            </div>
          ...
          <div className="detail-sidebar">
            ...
            <div className="sidebar-about">
              ...
              <p>Client: <strong>SterloCare</strong></p>
              <p>Service: </p>
