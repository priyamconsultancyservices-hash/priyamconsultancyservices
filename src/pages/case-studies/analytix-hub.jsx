...
export default function CaseStudy() {
 ...
 <div className="detail-section">
              ...
              <p>Analytix Hub is an IT services firm delivering technology solutions and operational support for business scaling needs.
</p>
            </div>
            <div className="detail-section">
              <h2>Overview</h2>
              <p>Analytix Hub needed rapid recruitment and precise payroll management to meet urgent project demands during a critical expansion.
</p>
            </div>

            <div className="detail-section">
              <h2>The Challenge</h2>
              <p>Facing time-critical hiring needs and payroll accuracy demands, the company needed to reduce the time-to-hire and ensure payroll precision without delaying project timelines.
</p>
            </div>
            ...
            <div className="detail-section">
              <h2>The Result</h2>
              <p>PCS helped Analytix Hub scale its workforce efficiently, reducing hiring turnaround by 40% and ensuring timely payroll. The company achieved smoother onboarding, improved efficiency, and uninterrupted project operations.</p>
            </div>
