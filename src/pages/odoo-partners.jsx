  ...
  return (
    <section style={{
      ...
      <div className="wc2-inner">
        ...
        <div>
    <div className="partners-header1">
            <div className="partners-eyebrow" style={{ marginBottom: '20px', textAlign: 'start' }}>Why choose Odoo</div>
          </div>          <h2 className="wc2-heading">
All-in-One Platform for Smarter Business Management          </h2>
