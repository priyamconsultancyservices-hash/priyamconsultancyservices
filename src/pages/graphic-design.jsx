...
const SERVICES = [
  ...
  { num: "04", icon: <img src="/img/icon/svc-website-app-graphics.webp" alt="Website and App Graphics" width="34" height="34" />, subtitle: "Community Building", title: "Website & App Graphics", desc: "Enhance user experience with custom graphic design elements including UI visuals, icon, and banners. Our graphic design company ensures consistency and usability across your website and mobile applications.", },
...
const PROCESS_STEPS = [
  ...
  { step: "02", title: "Research & Analyze", phase: "Custom Roadmap", desc: "We study competitors, audit existing brand assets, and analyze current market and design trends to identify opportunities for visual differentiation. From typography and colour psychology to layout preferences, user behavior, and evolving design patterns, we gather the insights needed to create visuals that stand out, communicate effectively, and resonate strongly with your target audience.", bullets: [] },
...
const faqData = [
  { q: "Does Hiring A Graphic Design Agency Change My Business Identity?", a: "Yes, Hiring a graphic design agency can enhance your business identity by tailoring visuals like logo, branding, and social media to reflect your unique values and vision." },
  { q: "What Services Does Your Graphic Design Company Offer?", a: "We offer logo design, branding, brochures, social media creatives, business cards, presentations, and more tailored to your brand." },
  { q: "Can Priyam Consultancy Graphic Design Make Changes to Our Existing Designs?", a: "Yes, we refresh and enhance existing designs while maintaining brand consistency and improving visual effectiveness." },
  { q: "Why Do I Need Branding For My Business?", a: "Branding builds trust, recognition, and emotional connection—driving customer loyalty and making your business stand out." },
  { q: "How Can I Choose My Graphic Design Strategy?", a: "We guide you based on goals, audience, competition, and industry to craft a strategy that aligns with your brand vision." },
  { q: "How Long Does It Take To Design A Logo?", a: "Typically, logo design take 3 to 5 working days, depending on the scope and the requirements." },
];
    ...
    <section className="approach" id="approach">
      ...
      <div className="ap-inner">
        <div className="ap-left">
          ...
          <h2 className="ap-heading">Creative Designs that <span>Speak Your Brand</span> </h2>
  ...
  return (
    <section className="smm-svc">
      ...
      <div className="smm-svc-hdr">
        <div className="partners-header1">
          <div className="partners-eyebrow" style={{ marginBottom: '20px', textAlign: 'start' }}>Our Specialized Graphic Design Services</div>
        </div>
        <h2 className="smm-svc-h2">Pixel Perfect. <span> <i>Purpose Driven. </i></span>Brand Defining</h2>
  ...
  return (
    <section className="smm-tp-section">
      ...
      <div className="smm-tp-header">
        <div className="partners-header1">
          <div className="partners-eyebrow" style={{ marginBottom: '20px', textAlign: 'start' }}>Our Proven Creative Design Process</div>
        </div>
        <h2 className="smm-tp-h2">Crafted for Impact, <em> <i>Aligned with Vision</i> </em></h2>
  ...
  return (
    <section className="smm-hww">
      ...
      <div className="smm-hww-header">
        <div className="partners-header1">
          <div className="partners-eyebrow" style={{ marginBottom: '20px', textAlign: 'start' }}>Our Focus on Your Brand Through Creative Design</div>
        </div>
        <h2 className="smm-hww-h2">Visualize Ideas. <span><i>Elevate Identity.  </i></span> Inspire Action.</h2>
      </div>
