...
// ─── Data ────────────────────────────────────────────────────────────────────
const SERVICES = [
  { num: "01", icon: <img src="/img/icon/svc-technical-seo.webp" alt="Technical SEO" width="28" height="28" />, subtitle: "Fix What's Holding You Back", title: "Technical SEO", desc: "Your website may look great but if it's not technically sound, Google won't care. We perform deep-dive audits to fix crawl errors, boost speed, improve mobile responsiveness, and optimize site architecture for maximum search engine performance." },
  { num: "02", icon: <img src="/img/icon/svc-on-page-seo.webp" alt="On-Page SEO" width="28" height="28" />, subtitle: "Optimize What You Already Have", title: "On-Page SEO", desc: "We turn your existing pages into conversion-ready SEO assets. From title tags to internal linking, our on-page strategies focus on user experience and search engine signals so every page pulls its weight in rankings and results." },
  { num: "03", icon: <img src="/img/icon/svc-content-management.webp" alt="Content Management" width="28" height="28" />, subtitle: "Content That Attracts and Converts", title: "Content Management", desc: "We don't write for bots, we write for buyers. PCS creates high-intent, keyword-driven content that educates, engages, and converts. From landing pages to long-form blogs, we build topical authority while driving relevant traffic." },
  { num: "04", icon: <img src="/img/icon/svc-link-building.webp" alt="Link Building" width="28" height="28" />, subtitle: "Earn Authority, Not Just Backlinks", title: "Link Building", desc: "Backlinks are still one of Google's top ranking factors but not all links are created equal. We secure high-quality, relevant backlinks through white-hat outreach and partnerships that actually move the needle." },
  { num: "05", icon: <img src="/img/icon/svc-local-seo.webp" alt="Local SEO" width="28" height="28" />, subtitle: "Win Local Searches, Win Local Customers", title: "Local SEO", desc: "Be the first name people see when they search locally. PCS optimizes your Google Business Profile, local citations, and review strategy to boost your map pack visibility and drive more footfalls or calls." },
  { num: "06", icon: <img src="/img/icon/svc-seo-strategy-reporting.webp" alt="SEO Strategy and Reporting" width="28" height="28" />, subtitle: "Know What's Working. And What's Next.", title: "SEO Strategy & Reporting", desc: "Get crystal-clear insights into your SEO performance. Our monthly reports go beyond vanity metrics showing you what's improving, what needs action, and where your next big SEO win lies." },
];
  ...
  return (
    <div ref={ref} className={`pcs-svc-panel${visible ? " vis" : ""}`} style={{transitionDelay:`${0.05 + index * 0.07}s`}}>
      ...
      <div className="pcs-sp-content">
        ...
        <div className="pcs-sp-title">{svc.title}</div>
  ...
  return (
    <section className="pcs-svc">
      ...
      <div className="pcs-svc-hdr">
           <div className="partners-header1">
                <div className="partners-eyebrow" style={{ marginBottom: '20px', textAlign: 'center' }}>Our Specialized SEO Marketing Services</div>
          </div>
        <h2 className="pcs-svc-h2">Every Keyword a Strategy.<span> Every Click a Step Forward.</span></h2>
      ...
      {isEven ? (
        <>
          ...
          <div className="pcs-tp-num-side">
            ...
            <div className="pcs-tp-step-title">{step.title}</div>
  ...
  return (
    <div ref={ref} className={`pcs-hww-arrow-item${visible ? " hww-vis" : ""}`}>
      <div className="pcs-hww-card">
        ...
        <div className="pcs-hww-card-title">{item.title}</div>
...
// faq section
const faqData = [
  { q: "How Long Does SEO Take To Show Results?", a: "SEO represents a long-term plan. Usually, you can anticipate some significant results in a 3 to 6 month period depending on your industry, competition, and the health of your website. PCS develops your SEO strategy for both short term wins and long term growth." },
  { q: "What’s The Difference Between SEO And Paid Ads?", a: "SEO works towards organic growth getting a website to rank higher on search engines naturally without spending money per click. Paid ads (like Google Ads), give you a quick visibility fix, but stop working once you cease spending money. SEO, builds long term value that just continues to get better over time." },
  { q: "Can You Guarantee #1 Ranking On Google?", a: "No agency can truthfully claim to guarantee a #1 ranking – and if they do, that’s a warning sign. What PCS guarantees is clear transparency on the work we’re doing, data-driven strategies and insights, and regular tracking so you can see the growth you need in relevant searches." },
  { q: "What Industries Do You Specialize in for SEO?", a: "We’ve worked across a broad spectrum of industries: ecommerce, real estate, healthcare, education, SaaS, and local service companies. Our strengths is that we know your market, and we can develop the strategies that are right for your niche." },
  { q: "Do You Provide Reports to Track SEO Progress?", a: "For sure. PCS will provide you with monthly performance reports that show the movements of keywords, the traffic growth, website technical fixes, and ROI metrics, so you know exactly where you stand." },
  { q: "Is SEO A One-Time Process or Ongoing?", a: "SEO is not a fix-it-once-then-forget-it process. Search engine algorithms continuously evolve, and your competitors’ optimization does too. You’ll constantly need to update content, make content improvements, and adjust technical settings in order to remain in the best position and continue growing." },
];
function FAQSection() {
