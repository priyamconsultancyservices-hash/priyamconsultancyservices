"use strict";(self.webpackChunknew_docs_pcs_website_design=self.webpackChunknew_docs_pcs_website_design||[]).push([["584"],{3177(e,t,r){r.d(t,{A:()=>a});var i=r(4848),o=r(6540);let n=`https://corsproxy.io/?${encodeURIComponent("https://www.priyamconsultancy.com/blog/feed/")}`;function a(){let[e,t]=(0,o.useState)([]),[r,a]=(0,o.useState)(!0),[s,c]=(0,o.useState)(null);return(0,o.useEffect)(()=>{fetch(n).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.text()}).then(e=>{t(Array.from(new DOMParser().parseFromString(e,"text/xml").querySelectorAll("item")).slice(0,3).map(e=>{let t=e.querySelector("enclosure"),r=e.getElementsByTagNameNS("http://search.yahoo.com/mrss/","content")[0],i=e.getElementsByTagNameNS("http://search.yahoo.com/mrss/","thumbnail")[0],o=e.getElementsByTagNameNS("http://purl.org/rss/1.0/modules/content/","encoded")[0],n=o?.textContent||"",a=n.match(/<img[^>]+src=["']([^"']+)["']/i),s=e.querySelector("description")?.textContent||"",c=s.match(/<img[^>]+src=["']([^"']+)["']/i),p=t?.getAttribute("url")||r?.getAttribute("url")||i?.getAttribute("url")||a?.[1]||c?.[1]||null,l=(n||s).replace(/<[^>]*>/g,"").replace(/&[^;]+;/g," ").trim(),m=l.length>340?l.slice(0,340)+"...":l,d=e.getElementsByTagName("link")[0],g=d?.textContent?.trim()||e.querySelector("guid")?.textContent||"#";return{guid:e.querySelector("guid")?.textContent||Math.random().toString(),title:e.querySelector("title")?.textContent?.trim()||"Untitled",link:g,thumbnail:p,excerpt:m}})),a(!1)}).catch(e=>{c(e.message),a(!1)})},[]),(0,i.jsxs)("section",{style:{width:"100%",padding:"4rem 1rem",boxSizing:"border-box",background:"#fff"},children:[(0,i.jsxs)("div",{style:{maxWidth:"1200px",margin:"0 auto"},children:[(0,i.jsxs)("div",{style:{textAlign:"center",marginBottom:"2.5rem"},children:[(0,i.jsx)("h2",{style:{fontSize:"2rem",fontWeight:700,margin:"0 0 0.5rem",color:"#111"},children:"Blogs"}),(0,i.jsx)("p",{style:{color:"#666",margin:0,fontSize:"1rem"},children:"Stay updated with the latest in digital marketing, growth strategies, and industry trends."})]}),r&&(0,i.jsx)("p",{style:{textAlign:"center",color:"#888"},children:"Loading..."}),s&&(0,i.jsxs)("p",{style:{textAlign:"center",color:"red"},children:["Error: ",s]}),(0,i.jsx)("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"1.5rem"},className:"blog-grid",children:e.map(e=>(0,i.jsxs)("a",{href:e.link,target:"_blank",rel:"noreferrer",style:{border:"1px solid #e5e7eb",borderRadius:"12px",overflow:"hidden",background:"#fff",display:"flex",flexDirection:"column",textDecoration:"none",color:"inherit",transition:"box-shadow 0.2s, transform 0.2s",cursor:"pointer"},onMouseEnter:e=>{e.currentTarget.style.boxShadow="0 8px 24px rgba(0,0,0,0.12)",e.currentTarget.style.transform="translateY(-3px)"},onMouseLeave:e=>{e.currentTarget.style.boxShadow="none",e.currentTarget.style.transform="translateY(0)"},children:[(0,i.jsx)("div",{style:{width:"100%",aspectRatio:"16/9",overflow:"hidden",background:"#1a2744"},children:e.thumbnail?(0,i.jsx)("img",{src:e.thumbnail,alt:e.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}):(0,i.jsx)("div",{style:{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",color:"#fff",opacity:.4,fontSize:"0.8rem"},children:"No image"})}),(0,i.jsxs)("div",{style:{padding:"1.25rem",display:"flex",flexDirection:"column",gap:"0.75rem"},children:[(0,i.jsx)("p",{style:{fontWeight:600,fontSize:"1.1rem",lineHeight:1.6,margin:0,color:"#111"},children:e.title}),(0,i.jsx)("p",{style:{color:"#444",fontSize:"0.875rem",lineHeight:1.6,flex:1,margin:0},children:e.excerpt}),(0,i.jsx)("span",{style:{display:"inline-block",background:"#E87C30",color:"#fff",padding:"0.6rem 1.5rem",borderRadius:"999px",fontWeight:500,alignSelf:"flex-start",marginTop:"0.5rem",fontSize:"0.875rem"},children:"Read More"})]})]},e.guid))})]}),(0,i.jsx)("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}},9393(e,t,r){r.d(t,{A:()=>n});var i=r(4848),o=r(6540);let n=function(){let e=(0,o.useRef)(null);return(0,o.useEffect)(()=>{let t=e.current;if(!t)return;let r=t.getContext("2d"),i="#ed8337",o,n,a=[],s;function c(){o=t.width=t.parentElement.offsetWidth,n=t.height=t.parentElement.offsetHeight}function p(){this.reset()}p.prototype.reset=function(){this.x=Math.random()*o,this.y=Math.random()*n,this.r=2.2*Math.random()+.6,this.type=.55>Math.random()?"dot":.5>Math.random()?"ring":"plus",this.speed=.35*Math.random()+.08,this.dir=Math.random()*Math.PI*2,this.alpha=.45*Math.random()+.1,this.pulse=Math.random()*Math.PI*2,this.pulseSpeed=.018*Math.random()+.008,this.size=4*Math.random()+2},p.prototype.update=function(){this.x+=Math.cos(this.dir)*this.speed,this.y+=Math.sin(this.dir)*this.speed,this.pulse+=this.pulseSpeed,this.dir+=(Math.random()-.5)*.015,this.x<-20&&(this.x=o+20),this.x>o+20&&(this.x=-20),this.y<-20&&(this.y=n+20),this.y>n+20&&(this.y=-20)},p.prototype.draw=function(){let e=this.alpha*(.7+.3*Math.sin(this.pulse));if(r.save(),r.globalAlpha=e,r.strokeStyle=r.fillStyle=i,r.lineWidth=1,"dot"===this.type)r.beginPath(),r.arc(this.x,this.y,this.r+.4*Math.sin(this.pulse),0,2*Math.PI),r.fill();else if("ring"===this.type){let e=this.size*(.9+.15*Math.sin(this.pulse));r.beginPath(),r.arc(this.x,this.y,e,0,2*Math.PI),r.stroke()}else{let e=this.size*(.9+.1*Math.sin(this.pulse));r.beginPath(),r.moveTo(this.x-e,this.y),r.lineTo(this.x+e,this.y),r.moveTo(this.x,this.y-e),r.lineTo(this.x,this.y+e),r.stroke()}r.restore()},window.addEventListener("resize",c),c(),a=[];let l=Math.floor(o*n/9e3);for(let e=0;e<Math.max(l,28);e++)a.push(new p);return!function e(){r.clearRect(0,0,o,n),function(){let e=a.filter(e=>"dot"===e.type);for(let t=0;t<e.length;t++)for(let o=t+1;o<e.length;o++){let n=e[t].x-e[o].x,a=e[t].y-e[o].y,s=Math.sqrt(n*n+a*a);s<110&&(r.save(),r.globalAlpha=(1-s/110)*.12,r.strokeStyle=i,r.lineWidth=.7,r.beginPath(),r.moveTo(e[t].x,e[t].y),r.lineTo(e[o].x,e[o].y),r.stroke(),r.restore())}}(),a.forEach(e=>{e.update(),e.draw()}),s=requestAnimationFrame(e)}(),()=>{cancelAnimationFrame(s),window.removeEventListener("resize",c)}},[]),(0,i.jsx)("section",{id:"cta-final",children:(0,i.jsxs)("div",{className:"cta-banner",style:{"--glow-x":"50%","--glow-y":"50%"},children:[(0,i.jsx)("canvas",{id:"ctaCanvas",ref:e}),(0,i.jsxs)("div",{className:"cta-banner-left",children:[(0,i.jsx)("div",{className:"partners-header",children:(0,i.jsx)("div",{className:"partners-eyebrow",style:{marginBottom:"20px",textAlign:"start"},children:"Ready to Start?"})}),(0,i.jsxs)("h2",{className:"cta-banner-heading",children:["Let's Talk About Your",(0,i.jsx)("br",{}),"Next Big ",(0,i.jsx)("span",{className:"hl-italic",children:"Growth Move"})]}),(0,i.jsx)("p",{className:"cta-banner-sub",children:"No pressure. Just a quick conversation to understand where you are-and how we can help you move forward."})]}),(0,i.jsxs)("div",{className:"cta-banner-right",children:[(0,i.jsxs)("a",{href:"#",className:"cta-bprimary",children:["Book a Free Consultation",(0,i.jsx)("svg",{viewBox:"0 0 16 16",fill:"none",children:(0,i.jsx)("path",{d:"M3 8h10M9 4l4 4-4 4",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})]}),(0,i.jsx)("a",{href:"#",className:"cta-bghost",children:"View All Services"})]})]})})}},7008(e,t,r){r.r(t),r.d(t,{default:()=>w});var i=r(4848),o=r(6540),n=r(8128),a=r(9393),s=r(3177),c=r(8230),p=r(3572);function l(){let e="https://www.priyamconsultancy.com/img/static-website.png";return(0,i.jsxs)(p.A,{children:[(0,i.jsx)("title",{children:"Professional WooCommerce Development for Business Growth  "}),(0,i.jsx)("meta",{name:"description",content:"WooCommerce development to create secure, scalable, and easy-to-manage online stores that help grow your business and increase sales."}),(0,i.jsx)("meta",{name:"keywords",content:"Woocommerce development, WooCommerce website, woocommerce development cost, woocommerce development agency, woocommerce development service, woocommerce development service coimbatore, woocommerce custom development, woocommerce payment gateway setup, WooCommerce setup services, woocommerce development company "}),(0,i.jsx)("link",{rel:"canonical",href:"https://www.priyamconsultancy.com/woocommerce-website-development/"}),(0,i.jsx)("meta",{property:"og:type",content:"website"}),(0,i.jsx)("meta",{property:"og:title",content:"Professional WooCommerce Development for Business Growth  "}),(0,i.jsx)("meta",{property:"og:description",content:"WooCommerce development to create secure, scalable, and easy-to-manage online stores that help grow your business and increase sales."}),(0,i.jsx)("meta",{property:"og:url",content:"https://www.priyamconsultancy.com/woocommerce-website-development/"}),(0,i.jsx)("meta",{property:"og:image",content:e}),(0,i.jsx)("meta",{property:"og:site_name",content:"PCS Business Solution"}),(0,i.jsx)("meta",{name:"twitter:card",content:"summary_large_image"}),(0,i.jsx)("meta",{name:"twitter:title",content:"Professional WooCommerce Development for Business Growth  "}),(0,i.jsx)("meta",{name:"twitter:description",content:"WooCommerce development to create secure, scalable, and easy-to-manage online stores that help grow your business and increase sales."}),(0,i.jsx)("meta",{name:"twitter:image",content:e}),(0,i.jsx)("script",{type:"application/ld+json",children:`
    {
