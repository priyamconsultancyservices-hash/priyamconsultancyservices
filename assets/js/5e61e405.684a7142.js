"use strict";(self.webpackChunknew_docs_pcs_website_design=self.webpackChunknew_docs_pcs_website_design||[]).push([["1057"],{3177(e,i,t){t.d(i,{A:()=>a});var r=t(4848),s=t(6540);function a(){let[e,i]=(0,s.useState)([]),[t,a]=(0,s.useState)(!0),[n,o]=(0,s.useState)(null);return(0,s.useEffect)(()=>{fetch("https://www.priyamconsultancy.com/blog/wp-json/wp/v2/posts?_embed&per_page=3").then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{i(e.map(e=>{let i=e._embedded?.["wp:featuredmedia"]?.[0]?.source_url||null,t=(e.excerpt?.rendered||"").replace(/<[^>]*>/g,"").replace(/&[^;]+;/g," ").trim(),r=t.length>200?t.slice(0,200)+"...":t,s=(e.title?.rendered||"Untitled").replace(/&[^;]+;/g," ").trim();return{guid:e.id,title:s,link:e.link,thumbnail:i,excerpt:r}})),a(!1)}).catch(e=>{o(e.message),a(!1)})},[]),(0,r.jsxs)("section",{style:{width:"100%",padding:"4rem 1rem",boxSizing:"border-box",background:"#fff"},children:[(0,r.jsxs)("div",{style:{maxWidth:"1200px",margin:"0 auto"},children:[(0,r.jsxs)("div",{style:{textAlign:"center",marginBottom:"2.5rem"},children:[(0,r.jsx)("h2",{style:{fontSize:"2rem",fontWeight:700,margin:"0 0 0.5rem",color:"#111"},children:"Blogs"}),(0,r.jsx)("p",{style:{color:"#666",margin:0,fontSize:"1rem"},children:"Stay updated with the latest in digital marketing, growth strategies, and industry trends."})]}),t&&(0,r.jsx)("p",{style:{textAlign:"center",color:"#888"},children:"Loading..."}),n&&(0,r.jsxs)("p",{style:{textAlign:"center",color:"red"},children:["Error: ",n]}),(0,r.jsx)("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"1.5rem"},className:"blog-grid",children:e.map(e=>(0,r.jsxs)("a",{href:e.link,target:"_blank",rel:"noreferrer",style:{border:"1px solid #e5e7eb",borderRadius:"12px",overflow:"hidden",background:"#fff",display:"flex",flexDirection:"column",textDecoration:"none",color:"inherit",transition:"box-shadow 0.2s, transform 0.2s",cursor:"pointer"},onMouseEnter:e=>{e.currentTarget.style.boxShadow="0 8px 24px rgba(0,0,0,0.12)",e.currentTarget.style.transform="translateY(-3px)"},onMouseLeave:e=>{e.currentTarget.style.boxShadow="none",e.currentTarget.style.transform="translateY(0)"},children:[(0,r.jsx)("div",{style:{width:"100%",aspectRatio:"16/9",overflow:"hidden",background:"#1a2744"},children:e.thumbnail?(0,r.jsx)("img",{src:e.thumbnail,alt:e.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}):(0,r.jsx)("div",{style:{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",color:"#fff",opacity:.4,fontSize:"0.8rem"},children:"No image"})}),(0,r.jsxs)("div",{style:{padding:"1.25rem",display:"flex",flexDirection:"column",gap:"0.75rem"},children:[(0,r.jsx)("p",{style:{fontWeight:600,fontSize:"1.1rem",lineHeight:1.6,margin:0,color:"#111"},children:e.title}),(0,r.jsx)("p",{style:{color:"#444",fontSize:"0.875rem",lineHeight:1.6,flex:1,margin:0},children:e.excerpt}),(0,r.jsx)("span",{style:{display:"inline-block",background:"#E87C30",color:"#fff",padding:"0.6rem 1.5rem",borderRadius:"999px",fontWeight:500,alignSelf:"flex-start",marginTop:"0.5rem",fontSize:"0.875rem"},children:"Read More"})]})]},e.guid))})]}),(0,r.jsx)("style",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})}},9393(e,i,t){t.d(i,{A:()=>a});var r=t(4848),s=t(6540);let a=function(){let e=(0,s.useRef)(null);return(0,s.useEffect)(()=>{let i=e.current;if(!i)return;let t=i.getContext("2d"),r="#ed8337",s,a,n=[],o;function l(){s=i.width=i.parentElement.offsetWidth,a=i.height=i.parentElement.offsetHeight}function d(){this.reset()}d.prototype.reset=function(){this.x=Math.random()*s,this.y=Math.random()*a,this.r=2.2*Math.random()+.6,this.type=.55>Math.random()?"dot":.5>Math.random()?"ring":"plus",this.speed=.35*Math.random()+.08,this.dir=Math.random()*Math.PI*2,this.alpha=.45*Math.random()+.1,this.pulse=Math.random()*Math.PI*2,this.pulseSpeed=.018*Math.random()+.008,this.size=4*Math.random()+2},d.prototype.update=function(){this.x+=Math.cos(this.dir)*this.speed,this.y+=Math.sin(this.dir)*this.speed,this.pulse+=this.pulseSpeed,this.dir+=(Math.random()-.5)*.015,this.x<-20&&(this.x=s+20),this.x>s+20&&(this.x=-20),this.y<-20&&(this.y=a+20),this.y>a+20&&(this.y=-20)},d.prototype.draw=function(){let e=this.alpha*(.7+.3*Math.sin(this.pulse));if(t.save(),t.globalAlpha=e,t.strokeStyle=t.fillStyle=r,t.lineWidth=1,"dot"===this.type)t.beginPath(),t.arc(this.x,this.y,this.r+.4*Math.sin(this.pulse),0,2*Math.PI),t.fill();else if("ring"===this.type){let e=this.size*(.9+.15*Math.sin(this.pulse));t.beginPath(),t.arc(this.x,this.y,e,0,2*Math.PI),t.stroke()}else{let e=this.size*(.9+.1*Math.sin(this.pulse));t.beginPath(),t.moveTo(this.x-e,this.y),t.lineTo(this.x+e,this.y),t.moveTo(this.x,this.y-e),t.lineTo(this.x,this.y+e),t.stroke()}t.restore()},window.addEventListener("resize",l),l(),n=[];let c=Math.floor(s*a/9e3);for(let e=0;e<Math.max(c,28);e++)n.push(new d);return!function e(){t.clearRect(0,0,s,a),function(){let e=n.filter(e=>"dot"===e.type);for(let i=0;i<e.length;i++)for(let s=i+1;s<e.length;s++){let a=e[i].x-e[s].x,n=e[i].y-e[s].y,o=Math.sqrt(a*a+n*n);o<110&&(t.save(),t.globalAlpha=(1-o/110)*.12,t.strokeStyle=r,t.lineWidth=.7,t.beginPath(),t.moveTo(e[i].x,e[i].y),t.lineTo(e[s].x,e[s].y),t.stroke(),t.restore())}}(),n.forEach(e=>{e.update(),e.draw()}),o=requestAnimationFrame(e)}(),()=>{cancelAnimationFrame(o),window.removeEventListener("resize",l)}},[]),(0,r.jsx)("section",{id:"cta-final",children:(0,r.jsxs)("div",{className:"cta-banner",style:{"--glow-x":"50%","--glow-y":"50%"},children:[(0,r.jsx)("canvas",{id:"ctaCanvas",ref:e}),(0,r.jsxs)("div",{className:"cta-banner-left",children:[(0,r.jsx)("div",{className:"partners-header",children:(0,r.jsx)("div",{className:"partners-eyebrow",style:{marginBottom:"20px",textAlign:"start"},children:"Ready to Start?"})}),(0,r.jsxs)("h2",{className:"cta-banner-heading",children:["Let's Talk About Your",(0,r.jsx)("br",{}),"Next Big ",(0,r.jsx)("span",{className:"hl-italic",children:"Growth Move"})]}),(0,r.jsx)("p",{className:"cta-banner-sub",children:"No pressure. Just a quick conversation to understand where you are-and how we can help you move forward."})]}),(0,r.jsxs)("div",{className:"cta-banner-right",children:[(0,r.jsxs)("a",{href:"#",className:"cta-bprimary",children:["Book a Free Consultation",(0,r.jsx)("svg",{viewBox:"0 0 16 16",fill:"none",children:(0,r.jsx)("path",{d:"M3 8h10M9 4l4 4-4 4",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})]}),(0,r.jsx)("a",{href:"#",className:"cta-bghost",children:"View All Services"})]})]})})}},9525(e,i,t){t.r(i),t.d(i,{default:()=>j});var r=t(4848),s=t(6540),a=t(9393),n=t(8128),o=t(8230),l=t(3572),d=t(3177);function c(){let e="https://www.priyamconsultancy.com/img/business-registration.png";return(0,r.jsxs)(l.A,{children:[(0,r.jsx)("title",{children:"Business Registration Services | Company Registration in Coimbatore "}),(0,r.jsx)("meta",{name:"description",content:"Professional Business Registration Services in Coimbatore. Get seamless company registration, legal support, and compliance guidance for your business growth. "}),(0,r.jsx)("meta",{name:"keywords",content:"Business Registration, Business Registration Services, Business Registration Consultants, Limited Company Registration Services, Private Limited Company Registration Services, Public Limited Company Registration Services, Limited Liability Partnership Services, Company Registration Consultants"}),(0,r.jsx)("link",{rel:"canonical",href:"https://www.priyamconsultancy.com/business-registrations/"}),(0,r.jsx)("meta",{property:"og:type",content:"website"}),(0,r.jsx)("meta",{property:"og:title",content:"Business Registration Services | Company Registration in Coimbatore "}),(0,r.jsx)("meta",{property:"og:description",content:"Professional Business Registration Services in Coimbatore. Get seamless company registration, legal support, and compliance guidance for your business growth. "}),(0,r.jsx)("meta",{property:"og:url",content:"https://www.priyamconsultancy.com/business-registrations/"}),(0,r.jsx)("meta",{property:"og:image",content:e}),(0,r.jsx)("meta",{property:"og:site_name",content:"Priyam Consultancy Services"}),(0,r.jsx)("meta",{name:"twitter:card",content:"summary_large_image"}),(0,r.jsx)("meta",{name:"twitter:title",content:"Business Registration Services | Company Registration in Coimbatore "}),(0,r.jsx)("meta",{name:"twitter:description",content:"Professional Business Registration Services in Coimbatore. Get seamless company registration, legal support, and compliance guidance for your business growth. "}),(0,r.jsx)("meta",{name:"twitter:image",content:e}),(0,r.jsx)("script",{type:"application/ld+json",children:`
        {
      ...
      `})]})}function p(){return(0,r.jsxs)("section",{className:"hero-section",style:{minHeight:"100svh",display:"grid",gridTemplateColumns:"1fr 1fr",alignItems:"center",gap:"2rem",padding:"1rem 6% 3rem",position:"relative",overflow:"hidden",background:"#004168"},children:[(0,r.jsx)("style",{children:`
      ...
      `}),(0,r.jsxs)("div",{className:"hero-content-col",style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column"},children:[(0,r.jsxs)("div",{className:"badge",children:[(0,r.jsx)("div",{className:"badge-dot"}),"Business Registration "]}),(0,r.jsxs)("h1",{className:"hero-heading",children:["Business Registration Partner for",(0,r.jsx)("span",{className:"underline-word orange",children:"Sustainable  "}),"Success"]}),(0,r.jsx)("p",{className:"hero-sub",children:"Your business deserves a solid foundation. From registration to ongoing compliance, we simplify the legal and regulatory maze so you can focus on building your brand, expanding your operations, and achieving sustainable growth. With expert guidance at every step, your business stays protected, credible, and ready for the future."}),(0,r.jsx)("div",{className:"hero-actions",children:(0,r.jsxs)("a",{className:"btn-fill",href:"/contact-us",children:[(0,r.jsx)("span",{children:"Explore More"}),(0,r.jsx)("div",{className:"btn-arr",children:"\u203A"})]})})]}),(0,r.jsx)("div",{className:"hero-img-col",style:{position:"relative",zIndex:2,display:"flex",alignItems:"center",justifyContent:"center"},children:(0,r.jsx)("div",{className:"hero-img-wrap",children:(0,r.jsx)("img",{src:"/img/busniess-registration.webp",alt:"Business Registration Illustration",className:"hero-img"})})})]})}function m(){let[e,i]=(0,s.useState)({name:"",email:"",phone:"",company:"",msg:""}),t=t=>{i({...e,[t.target.name]:t.target.value})};return(0,r.jsxs)("section",{className:"approach",id:"approach",children:[(0,r.jsx)("style",{children:`
    ...
    text-align: center;
      ...
      `}),(0,r.jsx)("div",{className:"rg-bg-c",style:{top:"-120px",right:"-120px",width:"400px",height:"400px",border:"1.5px solid rgba(237,131,55,.1)"}}),(0,r.jsx)("div",{className:"rg-bg-c",style:{bottom:"-100px",left:"-80px",width:"300px",height:"300px",border:"1.5px solid rgba(237,131,55,.08)"}}),(0,r.jsxs)("div",{style:{textAlign:"center",marginBottom:"60px",position:"relative",zIndex:2},children:[(0,r.jsx)("div",{className:"partners-header1",children:(0,r.jsx)("h2",{className:"partners-eyebrow",style:{marginBottom:"20px",textAlign:"start"},children:"Our Specialized Business Registration Services"})}),(0,r.jsxs)("h3",{className:"rg-sec-h",children:["Every Step ",(0,r.jsx)("i",{children:" Legally Sound."})," Every Registration Tailored."]}),(0,r.jsx)("p",{className:"rg-sec-sub",children:"Priyam Consultancy Services crafts tailored business registration solutions aligned with your goals and growth vision."})]}),(0,r.jsxs)("div",{className:"rg-layout",children:[(0,r.jsx)("div",{className:"rg-left",children:g.map((t,s)=>(0,r.jsxs)("div",{children:[(0,r.jsxs)("div",{className:`rg-item${e===s?" active":""}`,onClick:()=>i(s),style:s===g.length-1&&e!==s?{borderBottom:"none"}:{},children:[(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"1rem",flex:1},children:[(0,r.jsx)("div",{className:"rg-icon-box",children:h[s]}),(0,r.jsx)("h4",{className:"rg-name",children:t.label})]}),(0,r.jsx)("span",{className:"rg-tag-pill",children:t.tag}),(0,r.jsx)("div",{className:"rg-item-arr",children:e===s?"\u25BE":"\u203A"})]}),e===s&&(0,r.jsxs)("div",{className:"rg-mobile-detail",children:[(0,r.jsx)("h5",{className:"rg-d-title",dangerouslySetInnerHTML:{__html:t.title}}),Array.isArray(t.desc)?t.desc.map((e,i)=>(0,r.jsx)("div",{className:"rg-d-desc",style:{marginBottom:i<t.desc.length-1?"0.8rem":"0"},children:e},i)):(0,r.jsx)("div",{className:"rg-d-desc",children:t.desc})]})]},s))}),(0,r.jsxs)("div",{className:"rg-right",children:[(0,r.jsxs)("div",{style:{position:"relative",zIndex:2,height:"100%",display:"flex",flexDirection:"column"},children:[(0,r.jsxs)("div",{className:"rg-d-eye",children:[(0,r.jsx)("div",{className:"rg-d-num",children:t.num}),(0,r.jsx)("div",{className:"rg-d-lbl",children:t.label})]}),(0,r.jsx)("h5",{className:"rg-d-title",dangerouslySetInnerHTML:{__html:t.title}}),Array.isArray(t.desc)?t.desc.map((e,i)=>(0,r.jsx)("div",{className:"rg-d-desc",style:{marginBottom:i<t.desc.length-1?"1rem":"0"},children:e},i)):(0,r.jsx)("div",{className:"rg-d-desc",children:t.desc}),(0,r.jsx)("div",{className:"rg-d-footer"})]}),(0,r.jsx)("div",{className:"rg-dots",children:g.map((i,t)=>(0,r.jsx)("div",{className:`rg-ddot${e===t?" active":""}`},t))})]})]})]})}let f=[{num:"01",color:"orange",icon:(0,r.jsx)("img",{src:"/img/icon/business-registration-discovery-assessment.webp",alt:"Discovery and Assessment",width:"35",height:"35"}),lbl:"Step 01 \xb7 Initiation",title:"Discovery & Assessment",desc:["We understand your business model, vision, and goals. By analyzing industry and growth plans, we tailor registration steps to build a strong foundation.","Business registration is more than paperwork\u2014it\u2019s the foundation of your growth. We manage every formality so you can focus on building and expanding. Your business starts strong, confident, and ready for long-term success."],time:"~1 Working Day",tColor:"blue",even:!1,last:!1},{num:"02",color:"blue",icon:(0,r.jsx)("img",{src:"/img/icon/business-registration-structure-planning.webp",alt:"Business Structure Planning",width:"35",height:"35"}),lbl:"Step 02 \xb7 Documentation",title:"Business Structure Planning",desc:"Our experts evaluate entity options based on liability, taxation, investment, and scalability, recommending the most suitable structure for efficiency and sustainable long-term growth.",time:"~2-3 Working Days",tColor:"orange",even:!0,last:!1},{num:"03",color:"orange",icon:(0,r.jsx)("img",{src:"/img/icon/business-registration-documentation-filing.webp",alt:"Documentation and Filing",width:"35",height:"35"}),lbl:"Step 03 \xb7 Filing",title:"Documentation & Filing",desc:"We manage the full registration process, preparing and submitting required forms, licenses, and approvals accurately and on time for smooth legal establishment.",time:"~2-4 Working Days",tColor:"blue",even:!1,last:!1},{num:"04",color:"blue",icon:(0,r.jsx)("img",{src:"/img/icon/business-registration-compliance-monitoring.webp",alt:"Compliance Setup and Monitoring",width:"35",height:"35"}),lbl:"Step 04 \xb7 Approval",title:"Compliance Setup & Monitoring",desc:"Post-registration, we establish compliance systems, manage licenses and filings, and track deadlines to keep your business secure, compliant, and operating smoothly year-round.",time:"~5-7 Working Days",tColor:"orange",even:!0,last:!1},{num:"05",color:"orange",icon:(0,r.jsx)("img",{src:"/img/icon/business-registration-continuous-support.webp",alt:"Continuous Support and Updates",width:"35",height:"35"}),lbl:"Step 05 \xb7 Complete",title:"Continuous Support & Updates",desc:"As regulations evolve, we keep your business updated and compliant, providing ongoing guidance to avoid penalties and stay prepared for future growth opportunities",time:"~1-2 Working Days",tColor:"blue",even:!1,last:!1},{num:"06",color:"blue",icon:(0,r.jsx)("img",{src:"/img/icon/business-registration-launch-maintenance.webp",alt:"Launch and Ongoing Maintenance",width:"35",height:"35"}),lbl:"Step 06 \xb7 Complete",title:"Launch & Ongoing Maintenance",desc:"After approval, we deploy your website with monitoring and configuration, providing continuous support, updates, and maintenance for long-term stability",time:"~2-3 Working Days",tColor:"orange",even:!0,last:!1}];function b(){return(0,r.jsxs)("section",{style:{position:"relative",overflow:"hidden",padding:"90px 0 100px"},children:[(0,r.jsx)("style",{children:`
      ...
      `}),(0,r.jsx)("div",{className:"sc-bg"}),(0,r.jsx)("div",{className:"sc-orb sc-orb-a"}),(0,r.jsx)("div",{className:"sc-orb sc-orb-b"}),(0,r.jsxs)("div",{className:"sc-inner",children:[(0,r.jsxs)("div",{style:{textAlign:"center",marginBottom:"90px"},children:[(0,r.jsx)("div",{className:"partners-header1",children:(0,r.jsx)("h2",{className:"partners-eyebrow",style:{marginBottom:"20px",textAlign:"start"},children:"Our Business Registration Execution Process"})}),(0,r.jsxs)("h3",{className:"sc-title",children:["Simplified, Transparent and ",(0,r.jsx)("em",{className:"sc-title-em",children:"Efficient Business "}),"Registration"]}),(0,r.jsx)("p",{className:"sc-sub",children:"Our Business Registration process at Priyam Consultancy Services is tailored to your business needs. We don\u2019t just file paperwork , we build a solid legal foundation for growth, credibility, and long-term success."})]}),(0,r.jsx)("div",{style:{position:"relative"},children:f.map((e,i)=>(0,r.jsxs)("div",{className:`sc-step${e.even?" sc-step-even":""}`,children:[(0,r.jsxs)("div",{className:"sc-num-col",children:[!e.last&&(0,r.jsx)("div",{className:"sc-line-v"}),(0,r.jsx)("div",{className:`sc-circle sc-${e.color}`,children:e.num})]}),(0,r.jsx)("div",{className:"sc-conn"}),(0,r.jsxs)("div",{className:`sc-card${e.last?" sc-card-final":""}`,children:[(0,r.jsx)("div",{className:`sc-card-top ${"blue"===e.color?"sc-top-blue":"sc-top-orange"}`}),(0,r.jsx)("span",{className:"sc-card-icon",children:e.icon}),(0,r.jsx)("div",{className:`sc-lbl sc-lbl-${"blue"===e.color?"blue":"orange"}`,children:e.lbl}),(0,r.jsx)("h4",{className:"sc-card-title",children:e.title}),(0,r.jsx)("div",{className:"sc-card-desc",children:e.desc})]})]},i))})]})]})}let x=[{title:"Strategic Registration & Planning",desc:"We start by understanding your business vision, operations, and long-term goals. Every step from entity selection to approvals is planned carefully and strategically. This ensures a strong, compliant foundation that supports sustainable growth. ",center:!1,icon:(0,r.jsx)("img",{src:"/img/icon/hww-strategic-planning.webp",alt:"Strategic Registration and Planning",width:"34",height:"34"})},{title:"Specialized Team & Clear Accountability",desc:"Our business registration specialists, legal advisors, and documentation experts handle every step accurately. Roles are defined clearly to ensure accountability, smooth execution, and confidence throughout the setup process.",center:!1,icon:(0,r.jsx)("img",{src:"/img/icon/hww-team-accountability.webp",alt:"Specialized Team and Clear Accountability",width:"34",height:"34"})},{title:"Review, Approve & Complete",desc:"Before finalizing any registration, our team reviews all documents, forms, and submissions to ensure accuracy and compliance. We deliver only when your business is fully registered and ready to operate.",center:!0,icon:(0,r.jsx)("img",{src:"/img/icon/hww-review-approve.webp",alt:"Review Approve and Complete",width:"34",height:"34"})},{title:"Continuous Support & Guidance",desc:"Even after registration, we provide continued support for compliance updates, regulatory changes, and operational queries, keeping your business fully compliant, adaptable, and growth-ready at every stage of your business journey ahead.",center:!1,icon:(0,r.jsx)("img",{src:"/img/icon/hww-continuous-support.webp",alt:"Continuous Support and Guidance",width:"34",height:"34"})}];function w(){return(0,r.jsxs)("section",{style:{position:"relative",background:"#004168",overflow:"hidden",padding:"60px 5% 81px"},children:[(0,r.jsx)("style",{children:`
      ...
      `}),(0,r.jsx)("div",{className:"hww-bg"}),(0,r.jsx)("div",{className:"hww-orb hww-orb-1"}),(0,r.jsx)("div",{className:"hww-orb hww-orb-2"}),(0,r.jsxs)("div",{style:{position:"relative",zIndex:2,margin:"0 auto"},children:[(0,r.jsxs)("div",{style:{textAlign:"center",marginBottom:"72px"},children:[(0,r.jsx)("div",{className:"partners-header1",children:(0,r.jsx)("div",{className:"partners-eyebrow",style:{marginBottom:"20px",textAlign:"start"},children:"How We Work"})}),(0,r.jsxs)("h2",{className:"hww-title",children:["Strategize Clearly. ",(0,r.jsx)("span",{className:"hww-accent",children:"Launch Securely."})]}),(0,r.jsx)("p",{className:"hww-sub",children:"Build a strong foundation that supports seamless operations, sustained growth, and long-term business success."})]}),(0,r.jsx)("div",{className:"hww-flow",children:x.map((e,i)=>(0,r.jsxs)("div",{className:`hww-step${e.center?" hww-step-center":""}`,children:[(0,r.jsxs)("div",{className:"hww-icon-wrap",children:[(0,r.jsx)("div",{className:"hww-ring",style:i%2==1?{animationDirection:"reverse",animationDuration:"18s"}:{}}),(0,r.jsx)("div",{className:"hww-disc"}),(0,r.jsx)("div",{className:"hww-svg",children:e.icon}),i<3&&(0,r.jsx)("div",{className:"hww-arrow",style:{animationDelay:`${.4*i}s`},children:(0,r.jsx)("svg",{viewBox:"0 0 28 14",fill:"none",children:(0,r.jsx)("path",{d:"M0 7h24M18 2l6 5-6 5",stroke:"#ed8337",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),(0,r.jsx)("h3",{className:"hww-step-title",children:e.title}),(0,r.jsx)("div",{className:"hww-step-desc",children:e.desc})]},i))})]})]})}let y=[{q:"What do you mean by business registration?",a:" Business registration is the legal process of officially establishing a business entity under applicable government regulations. It provides legal recognition, enables tax registration, supports banking and compliance requirements, and allows businesses to operate professionally within a structured legal framework."},{q:"How many types of business registration are there?",a:"Common types of business registration in India include Sole Proprietorship, Partnership Firm, Limited Liability Partnership (LLP), One Person Company (OPC), Private Limited Company, and Public Limited Company. The ideal structure depends on ownership, liability, compliance needs, and long-term business objectives."},{q:"Is GST registration mandatory after business registration?",a:"GST registration depends on your business turnover, industry type, and operational requirements. Businesses exceeding the prescribed turnover limit or involved in interstate trade, ecommerce, or specific taxable services are generally required to obtain GST registration under applicable regulations."},{q:"Can a single person establish a business?",a:" Yes, a single person can legally establish a business in India through structures like Sole Proprietorship or One Person Company (OPC). These options allow individuals to start and manage businesses independently while meeting applicable legal, taxation, and compliance requirements."},{q:"What documents are required for business registration?",a:"Business registration generally requires PAN card, Aadhaar card, address proof, passport-size photographs, business address proof, and bank details. Additional documents may vary depending on the selected business structure, partners, directors, or specific registration and licensing requirements."},{q:"How much time does it take in India to register a business?",a:"The business registration timeline in India depends on the business structure and documentation readiness. Typically, registration can take anywhere between 5 to 15 working days, including approvals, verification processes, and statutory registrations required for legal business operations."}];function v(){let[e,i]=(0,s.useState)(null),t=t=>{i(e===t?null:t)};return(0,r.jsxs)("section",{className:"faq-section",children:[(0,r.jsx)("div",{className:"partners-header2",style:{textAlign:"center",marginTop:"20px"},children:(0,r.jsx)("h2",{className:"partners-eyebrow",children:"Frequently Asked Questions"})}),(0,r.jsxs)("div",{className:"container",style:{width:"100%"},children:[(0,r.jsx)("div",{className:"faq-head",children:(0,r.jsxs)("h3",{className:"faq-h3",children:["Queries That Could ",(0,r.jsx)("span",{children:"Hold You Back"})]})}),(0,r.jsxs)("div",{className:"faq-wrapper",children:[(0,r.jsx)("div",{className:"faq-col",children:y.slice(0,3).map((i,s)=>(0,r.jsxs)("div",{className:"faq-item",children:[(0,r.jsxs)("div",{className:"faq-question",onClick:()=>t(s),children:[(0,r.jsx)("span",{children:i.q}),(0,r.jsx)("span",{className:"icon",children:e===s?"\u2212":"+"})]}),e===s&&(0,r.jsx)("div",{className:"faq-answer",children:i.a})]},s))}),(0,r.jsx)("div",{className:"faq-col",children:y.slice(3,6).map((i,s)=>(0,r.jsxs)("div",{className:"faq-item",children:[(0,r.jsxs)("div",{className:"faq-question",onClick:()=>t(s+3),children:[(0,r.jsx)("span",{children:i.q}),(0,r.jsx)("span",{className:"icon",children:e===s+3?"\u2212":"+"})]}),e===s+3&&(0,r.jsx)("div",{className:"faq-answer",children:i.a})]},s+3))})]})]})]})}function j(){return(0,r.jsxs)(o.A,{children:[(0,r.jsx)(c,{}),(0,r.jsx)(p,{}),(0,r.jsx)(m,{}),(0,r.jsx)(u,{}),(0,r.jsx)(b,{}),(0,r.jsx)(w,{}),(0,r.jsx)(v,{}),(0,r.jsx)(d.A,{}),(0,r.jsx)(a.A,{})]})}}}]);