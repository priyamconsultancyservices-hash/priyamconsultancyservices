"use strict";(self.webpackChunknew_docs_pcs_website_design=self.webpackChunknew_docs_pcs_website_design||[]).push([["4823"],{9393(e,t,i){i.d(t,{A:()=>a});var n=i(4848),s=i(6540);let a=function(){let e=(0,s.useRef)(null);return(0,s.useEffect)(()=>{let t=e.current;if(!t)return;let i=t.getContext("2d"),n="#ed8337",s,a,r=[],o;function l(){s=t.width=t.parentElement.offsetWidth,a=t.height=t.parentElement.offsetHeight}function c(){this.reset()}c.prototype.reset=function(){this.x=Math.random()*s,this.y=Math.random()*a,this.r=2.2*Math.random()+.6,this.type=.55>Math.random()?"dot":.5>Math.random()?"ring":"plus",this.speed=.35*Math.random()+.08,this.dir=Math.random()*Math.PI*2,this.alpha=.45*Math.random()+.1,this.pulse=Math.random()*Math.PI*2,this.pulseSpeed=.018*Math.random()+.008,this.size=4*Math.random()+2},c.prototype.update=function(){this.x+=Math.cos(this.dir)*this.speed,this.y+=Math.sin(this.dir)*this.speed,this.pulse+=this.pulseSpeed,this.dir+=(Math.random()-.5)*.015,this.x<-20&&(this.x=s+20),this.x>s+20&&(this.x=-20),this.y<-20&&(this.y=a+20),this.y>a+20&&(this.y=-20)},c.prototype.draw=function(){let e=this.alpha*(.7+.3*Math.sin(this.pulse));if(i.save(),i.globalAlpha=e,i.strokeStyle=i.fillStyle=n,i.lineWidth=1,"dot"===this.type)i.beginPath(),i.arc(this.x,this.y,this.r+.4*Math.sin(this.pulse),0,2*Math.PI),i.fill();else if("ring"===this.type){let e=this.size*(.9+.15*Math.sin(this.pulse));i.beginPath(),i.arc(this.x,this.y,e,0,2*Math.PI),i.stroke()}else{let e=this.size*(.9+.1*Math.sin(this.pulse));i.beginPath(),i.moveTo(this.x-e,this.y),i.lineTo(this.x+e,this.y),i.moveTo(this.x,this.y-e),i.lineTo(this.x,this.y+e),i.stroke()}i.restore()},window.addEventListener("resize",l),l(),r=[];let d=Math.floor(s*a/9e3);for(let e=0;e<Math.max(d,28);e++)r.push(new c);return!function e(){i.clearRect(0,0,s,a),function(){let e=r.filter(e=>"dot"===e.type);for(let t=0;t<e.length;t++)for(let s=t+1;s<e.length;s++){let a=e[t].x-e[s].x,r=e[t].y-e[s].y,o=Math.sqrt(a*a+r*r);o<110&&(i.save(),i.globalAlpha=(1-o/110)*.12,i.strokeStyle=n,i.lineWidth=.7,i.beginPath(),i.moveTo(e[t].x,e[t].y),i.lineTo(e[s].x,e[s].y),i.stroke(),i.restore())}}(),r.forEach(e=>{e.update(),e.draw()}),o=requestAnimationFrame(e)}(),()=>{cancelAnimationFrame(o),window.removeEventListener("resize",l)}},[]),(0,n.jsx)("section",{id:"cta-final",children:(0,n.jsxs)("div",{className:"cta-banner",style:{"--glow-x":"50%","--glow-y":"50%"},children:[(0,n.jsx)("canvas",{id:"ctaCanvas",ref:e}),(0,n.jsxs)("div",{className:"cta-banner-left",children:[(0,n.jsx)("div",{className:"partners-header",children:(0,n.jsx)("div",{className:"partners-eyebrow",style:{marginBottom:"20px",textAlign:"start"},children:"Ready to Start?"})}),(0,n.jsxs)("h2",{className:"cta-banner-heading",children:["Let's Talk About Your",(0,n.jsx)("br",{}),"Next Big ",(0,n.jsx)("span",{className:"hl-italic",children:"Growth Move"})]}),(0,n.jsx)("p",{className:"cta-banner-sub",children:"No pressure. Just a quick conversation to understand where you are-and how we can help you move forward."})]}),(0,n.jsxs)("div",{className:"cta-banner-right",children:[(0,n.jsxs)("a",{href:"#",className:"cta-bprimary",children:["Book a Free Consultation",(0,n.jsx)("svg",{viewBox:"0 0 16 16",fill:"none",children:(0,n.jsx)("path",{d:"M3 8h10M9 4l4 4-4 4",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})})]}),(0,n.jsx)("a",{href:"#",className:"cta-bghost",children:"View All Services"})]})]})})}},7176(e,t,i){i.r(t),i.d(t,{default:()=>W});var n=i(4848),s=i(6540),a=i(3572),r=i(9393),o=i(8230);let l=({size:e=26})=>(0,n.jsx)("img",{src:"/img/icon/placeholder.webp",alt:"icon",width:e,height:e,style:{objectFit:"contain",opacity:.4}}),c="#ed8337",d=[{name:"Business Registration",icon:"\u{1F3E2}",svg:`<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      <rect x="0" y="0" width="220" height="46" rx="18" fill="${c}"/>
      <rect x="0" y="30" width="220" height="16" fill="${c}"/>
      ...
      <text x="177" y="38" text-anchor="middle" font-size="7" fill="${c}" font-family="Poppins,sans-serif" font-weight="700">Fast &amp; Legal</text>
      ...
      <polygon points="92,54 104,54 104,66" fill="${c}" opacity="0.45"/>
      <polygon points="92,54 104,66 92,66" fill="${c}" opacity="0.2"/>
      <rect x="42" y="68" width="46" height="5" rx="2.5" fill="${c}" opacity="0.85"/>
      ...
      <circle cx="69" cy="130" r="13" fill="#fff" stroke="${c}" stroke-width="1.5" filter="url(#bsh)"/>
      <circle cx="69" cy="130" r="9" fill="${c}" opacity="0.12"/>
      <text x="69" y="135" text-anchor="middle" font-size="13" fill="${c}" font-weight="900">\u{2713}</text>
      <circle cx="69" cy="130" r="13" fill="none" stroke="${c}" stroke-width="2">
      ...
      <rect x="122" y="60" width="84" height="28" rx="7" fill="${c}"/>
      ...
      <line x1="164" y1="88" x2="164" y2="96" stroke="${c}" stroke-width="1.5" stroke-dasharray="2,2"/>
      <rect x="122" y="96" width="84" height="28" rx="7" fill="#fff4ee" stroke="${c}" stroke-width="1"/>
      <circle cx="135" cy="110" r="9" fill="${c}" opacity="0.7"/>
      ...
      <text x="110" y="171.5" text-anchor="middle" font-size="6.5" fill="${c}" font-family="Poppins,sans-serif" font-weight="600">Fast  \u{2022}  Legal  \u{2022}  Trusted  \u{2022}  End-to-End</text>
      ...
      <text x="182" y="38" text-anchor="middle" font-size="7" fill="${c}" font-family="Poppins,sans-serif" font-weight="700">\u{2191} 48% ROI</text>
      ...
      <rect x="34" y="126" width="16" height="10" rx="3" fill="${c}" opacity="0.25"/>
      <rect x="60" y="114" width="16" height="22" rx="3" fill="${c}" opacity="0.4"/>
      <rect x="86" y="98" width="16" height="38" rx="3" fill="${c}" opacity="0.6"/>
      <rect x="112" y="80" width="16" height="56" rx="3" fill="${c}" opacity="0.82"/>
      <rect x="138" y="86" width="16" height="50" rx="3" fill="${c}" opacity="0.9"/>
      <rect x="164" y="66" width="16" height="70" rx="3" fill="${c}"/>
      ...
      <circle cx="172" cy="65" r="5" fill="${c}">
      ...
      <text x="172" y="150" text-anchor="middle" font-size="6" fill="${c}" font-family="Poppins,sans-serif" font-weight="700">Jun</text>
      <rect x="10" y="156" width="34" height="12" rx="6" fill="#fff0e6"/><text x="27" y="164" text-anchor="middle" font-size="6.5" fill="${c}" font-family="Poppins,sans-serif" font-weight="600">SEO</text>
      <rect x="48" y="156" width="40" height="12" rx="6" fill="#fff0e6"/><text x="68" y="164" text-anchor="middle" font-size="6.5" fill="${c}" font-family="Poppins,sans-serif" font-weight="600">Social</text>
      <rect x="92" y="156" width="34" height="12" rx="6" fill="#fff0e6"/><text x="109" y="164" text-anchor="middle" font-size="6.5" fill="${c}" font-family="Poppins,sans-serif" font-weight="600">PPC</text>
      <rect x="130" y="156" width="40" height="12" rx="6" fill="#fff0e6"/><text x="150" y="164" text-anchor="middle" font-size="6.5" fill="${c}" font-family="Poppins,sans-serif" font-weight="600">Email</text>
      <rect x="174" y="156" width="36" height="12" rx="6" fill="${c}"/><text x="192" y="164" text-anchor="middle" font-size="6.5" fill="#fff" font-family="Poppins,sans-serif" font-weight="600">Ads</text>
      ...
      <rect x="158" y="28" width="48" height="14" rx="7" fill="#fff"/>
      <text x="182" y="38" text-anchor="middle" font-size="7" fill="${c}" font-family="Poppins,sans-serif" font-weight="700">UI/UX Pro</text>
      ...
      <rect x="10" y="52" width="182" height="20" rx="10" fill="${c}"/>
      <rect x="10" y="63" width="182" height="9" fill="${c}"/>
      ...
      <rect x="18" y="74" width="166" height="20" rx="5" fill="${c}" opacity="0.85"/>
      ...
      <text x="44" y="128" text-anchor="middle" font-size="6" fill="${c}" font-family="Poppins,sans-serif" font-weight="700">Design</text>
      <rect x="86" y="108" width="52" height="28" rx="6" fill="#f0c0a0"/>
      <rect x="84" y="105" width="52" height="28" rx="6" fill="#fff" stroke="${c}" stroke-width="1" filter="url(#wsh)"/>
      <text x="110" y="117" text-anchor="middle" font-size="13">\u{26A1}</text>
      <text x="110" y="128" text-anchor="middle" font-size="6" fill="${c}" font-family="Poppins,sans-serif" font-weight="700">Speed</text>
      ...
      <text x="167" y="128" text-anchor="middle" font-size="6" fill="${c}" font-family="Poppins,sans-serif" font-weight="700">Dev</text>
      <polygon points="110,82 114,90 111.5,89 110.5,93 107,86" fill="${c}" opacity="0.9">
        <animateTransform attributeName="transform" type="translate" values="0,0;20,8;0,0" dur="2.8s" repeatCount="indefinite"/>
      </polygon>
      <rect x="10" y="148" width="34" height="11" rx="5.5" fill="#fff0e6" stroke="${c}" stroke-width="0.8"/><text x="27" y="155.5" text-anchor="middle" font-size="6" fill="${c}" font-family="Poppins,sans-serif">React</text>
      <rect x="48" y="148" width="38" height="11" rx="5.5" fill="#fff0e6" stroke="${c}" stroke-width="0.8"/><text x="67" y="155.5" text-anchor="middle" font-size="6" fill="${c}" font-family="Poppins,sans-serif">Next.js</text>
      <rect x="90" y="148" width="38" height="11" rx="5.5" fill="#fff0e6" stroke="${c}" stroke-width="0.8"/><text x="109" y="155.5" text-anchor="middle" font-size="6" fill="${c}" font-family="Poppins,sans-serif">Node.js</text>
      <rect x="132" y="148" width="30" height="11" rx="5.5" fill="#fff0e6" stroke="${c}" stroke-width="0.8"/><text x="147" y="155.5" text-anchor="middle" font-size="6" fill="${c}" font-family="Poppins,sans-serif">UI/UX</text>
      <rect x="166" y="148" width="44" height="11" rx="5.5" fill="${c}"/><text x="188" y="155.5" text-anchor="middle" font-size="6" fill="#fff" font-family="Poppins,sans-serif">50+ Sites</text>
      <rect x="10" y="163" width="200" height="14" rx="7" fill="#fff8f3" stroke="#ffe0cc" stroke-width="1"/>
      <text x="110" y="172.5" text-anchor="middle" font-size="6.5" fill="${c}" font-weight="800" font-family="Poppins,sans-serif">50+ Built \xb7 4.9\u{2605} Rating \xb7 3 Day Delivery</text>
      ...
      <text x="179" y="38" text-anchor="middle" font-size="7" fill="${c}" font-family="Poppins,sans-serif" font-weight="700">Team Pulse</text>
      ...
      <circle cx="82" cy="108" r="48" fill="none" stroke="${c}" stroke-width="13"
      ...
      <circle cx="82" cy="108" r="54" fill="none" stroke="${c}" stroke-width="1.5" opacity="0.2">
      ...
      <!-- Center text -->
      <text x="82" y="101" text-anchor="middle" font-size="22" fill="${c}" font-weight="800" font-family="Poppins,sans-serif">90%</text>
      <text x="82" y="114" text-anchor="middle" font-size="7.5" fill="#aaa" font-family="Poppins,sans-serif">Satisfaction</text>
      <text x="82" y="124" text-anchor="middle" font-size="7" fill="${c}" font-family="Poppins,sans-serif" font-weight="600">\u{1F60A} Excellent</text>

      <!-- Right side stat cards -->
      <rect x="146" y="52" width="66" height="26" rx="8" fill="#fff4ee" stroke="#ffe0cc" stroke-width="1"/>
      <text x="179" y="63" text-anchor="middle" font-size="8" fill="${c}" font-weight="800" font-family="Poppins,sans-serif">\u{1F60A} 4.8</text>
      ...
      <text x="179" y="95" text-anchor="middle" font-size="8" fill="${c}" font-weight="800" font-family="Poppins,sans-serif">500+</text>
      <text x="179" y="105" text-anchor="middle" font-size="6" fill="#aaa" font-family="Poppins,sans-serif">Placements</text>

      <rect x="146" y="116" width="66" height="26" rx="8" fill="${c}"/>
      ...
      <rect x="146" y="116" width="66" height="26" rx="8" fill="none" stroke="${c}" stroke-width="2">
      ...
      <text x="50" y="165" text-anchor="middle" font-size="7.5" fill="${c}" font-weight="800" font-family="Poppins,sans-serif">500+</text>
      ...
      <text x="118" y="165" text-anchor="middle" font-size="7.5" fill="${c}" font-weight="800" font-family="Poppins,sans-serif">98%</text>
      ...
      <text x="178" y="165" text-anchor="middle" font-size="7.5" fill="${c}" font-weight="800" font-family="Poppins,sans-serif">4.9\u{2605}</text>
